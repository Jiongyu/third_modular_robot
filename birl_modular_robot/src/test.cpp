...
int main(int argc, char const *argv[])
{
    ...
    // 求解夹持点相对于carmera
    std::vector<double>p1{0, 50, 50};
    std::vector<double>p2{0, -50, 50};
    // 机器人tcp相对于base
    std::vector<double>tcp{507.8,0,0,0,0,3.141592};
    // 夹持点相对于base
    std::vector<double>grasp_point;
    grasp_point.resize(6);
    demo.findGraspPointByLine(p1, p2, tcp, GraspIntelligent::G0_GRIPPER, &grasp_point);
